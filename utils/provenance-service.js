        ...
        for (const claim of claims) {
            ...
            if (claim.status === 'supported') {
                ...
                if (!hasVerifiedSource) {
                    throw this.invalid('Claims can only be supported by reviewer-verified sources');
                }
            }
            if (claim.status === 'waived' && (!claim.notes || !claim.notes.trim())) {
                throw this.invalid('Waived claims require a reviewer note');
            }
        }
