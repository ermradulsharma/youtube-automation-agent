...
[![CI](https://github.com/ermradulsharma/youtube-automation-agent/actions/workflows/ci.yml/badge.svg)](https://github.com/ermradulsharma/youtube-automation-agent/actions/workflows/ci.yml)
...
## More Tools by ermradulsharma

If this was useful, check out:

- [darkzloop](https://github.com/ermradulsharma/darkzloop): terminal agent runner that turns any LLM into a disciplined software engineer (FSM control, model-agnostic, BYO auth)
- [darkzBOX](https://github.com/ermradulsharma/darkzBOX): open-source Instantly.ai clone with smart automated email replies
- [open-sales-researcher](https://github.com/ermradulsharma/open-sales-researcher): autonomous B2B company research. Works with Claude Code, Cursor, Copilot.
- [darkzseo](https://github.com/ermradulsharma/darkzseo): SEO tooling

## Built by

[@ermradulsharma](https://github.com/ermradulsharma), a solo builder shipping AI automation and developer tools. Find me on [X](https://x.com/ermradulsharma) and [laderalabs.io](https://laderalabs.io).

If Lumen saves you time, a star helps it reach more developers.

## Contributing

See [CONTRIBUTING.md](CONTRIBUTING.md) for ground rules (short version: one focused concern per PR, no lockfile churn, lint + tests must pass). For questions and setup help, use [Discussions](https://github.com/ermradulsharma/youtube-automation-agent/discussions) — Issues is for bugs.
