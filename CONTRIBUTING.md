...
Check the [open issues](https://github.com/ermradulsharma/youtube-automation-agent/issues) and the roadmap in the latest [release notes](https://github.com/ermradulsharma/youtube-automation-agent/releases). Current priorities: Gemini image/TTS parity, slideshow rendering performance, and template-content quality.
