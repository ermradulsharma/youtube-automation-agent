...
class ContentStrategyAgent {
  ...
  async fetchYouTubeTrends() {
    try {
      ...
      this.logger.warn('Failed to fetch YouTube trends (using fallback trend analysis):', error.message || error);
      return [];
    }
  }
  ...
  async getChannelVideos(channelId) {
    try {
      ...
      this.logger.warn(`Failed to get channel videos for ${channelId}:`, error.message || error);
      return [];
    }
  }
